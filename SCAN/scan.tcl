...
# Ensure the flag matches your version ('-file' is standard)
puts "Running Modus analysis..."
exec modus -file ./test_scripts/runmodus.dfa.tcl

# 4. Insert the identified test points into the design
# Replace '<modus_output_file>' with the actual file generated by Modus
add_analyzed_test_points -input_test_point_file ./test_scripts/test_point_results.tpi

# 5. Update DFT status of the new registers (CRITICAL)
check_dft_rules
