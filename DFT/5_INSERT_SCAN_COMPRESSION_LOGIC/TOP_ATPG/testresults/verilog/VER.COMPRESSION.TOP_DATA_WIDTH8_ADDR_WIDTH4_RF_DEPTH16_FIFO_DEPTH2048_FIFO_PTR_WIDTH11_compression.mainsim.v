...
//  SCAN OFFSET...............16.000   PULSE WIDTH...............8.000       //
//                                                                           //
//  Active TESTMODEs TM = 2 ..COMPRESSION                                    //
//                                                                           //
//***************************************************************************//

// Command Line: write_vectors -WORKDIR /home/admin/DFT/SOCX/DFT/5_INSERT_SCAN_COMPRESSION_LOGIC/TOP_ATPG -TESTMODE COMPRESSION -INEXPERIMENT TOP_DATA_WIDTH8_ADDR_WIDTH4_RF_DEPTH16_FIFO_DEPTH2048_FIFO_PTR_WIDTH11_compression -STDOUT summary -language verilog -scanformat serial

  `timescale 1 ns / 1 ps

  module TOP_ATPG_COMPRESSION_TOP_DATA_WIDTH8_ADDR_WIDTH4_RF_DEPTH16_FIFO_DEPTH2048_FIFO_PTR_WIDTH11_compression ;
  ...
  initial 
    begin 
      ...
      if ( $test$plusargs ( "vcd" ) )  begin 
        $dumpfile("out.vcd"); 
        $dumpvars(0,TOP_ATPG_COMPRESSION_TOP_DATA_WIDTH8_ADDR_WIDTH4_RF_DEPTH16_FIFO_DEPTH2048_FIFO_PTR_WIDTH11_compression ); 
      end  
...
//***************************************************************************//
  ...
  task sim_vector_file; 
    begin 
      ...
      $display ( "\nINFO (TVE-189): Design:  TOP_DATA_WIDTH8_ADDR_WIDTH4_RF_DEPTH16_FIFO_DEPTH2048_FIFO_PTR_WIDTH11   Test Mode:  COMPRESSION   InExperiment:  TOP_DATA_WIDTH8_ADDR_WIDTH4_RF_DEPTH16_FIFO_DEPTH2048_FIFO_PTR_WIDTH11_compression " ); 
...
//***************************************************************************//
  ...
  task Scan_Preconditioning_Sequence_TM_2_SEQ_1_SOP_1; 
    begin 
      ...
      stim_PIs [4] = 1'b0;      // pinName = DFT_spreader;  tf = -SE  ; testOffset = 0.000000;  scanOffset = 0.000000;  
...
//***************************************************************************//
  ...
  task Scan_Sequence_TM_2_SEQ_3_SOP_1; 
    begin 
...
//***************************************************************************//
  ...
  task Scan_Exit_Sequence_TM_2_SEQ_4_SOP_1; 
    begin 
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SEQNUM ) 
                    ...
                    3: begin 
                      rc_read = $fscanf ( DATAID, "%d", MAX ); 
                      if ( rc_read > 0 )  begin 
                        if ( sim_range )  Scan_Sequence_TM_2_SEQ_3_SOP_1; 
                      end  
                      else  bad_cmd_code; 
                      line_number = line_number + 1; 
                    end  
                    ...
                    4: begin 
                      rc_read = $fscanf ( DATAID, "%d", MAX ); 
                      if ( rc_read > 0 )  begin 
                        if ( sim_range )  Scan_Exit_Sequence_TM_2_SEQ_4_SOP_1; 
                      end  
                      else  bad_cmd_code; 
                      line_number = line_number + 1; 
                    end  
